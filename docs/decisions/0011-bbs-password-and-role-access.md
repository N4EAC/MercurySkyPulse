...
authenticate with a fresh 60-second nonce and HMAC-SHA-256 proof, so the password
is not transmitted. A proof binds the BBS session to one callsign and local role.
