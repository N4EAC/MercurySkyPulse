...
if defined MSP_ISCC (
    echo Installer complete: dist\installer\MercurySkyPulse-0.1.6-windows-x86_64-setup.exe
) else (
...
"%MSP_ISCC%" /Qp /DMyAppVersion=0.1.6 packaging\windows\MercurySkyPulse.iss
if errorlevel 1 (
